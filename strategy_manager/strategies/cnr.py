...
class Strategy:
    ...
    def on_fill(self, trade, fill):
        print("from vow.py on_fill function")
        # Handle fill event
    ...
    def run(self):
        ...
        trade = self.trade_manager.trade(contract,1000,order_type='MKT',orderRef=self.strategy_symbol,algo = True,urgency="Urgent",useRth=True)
